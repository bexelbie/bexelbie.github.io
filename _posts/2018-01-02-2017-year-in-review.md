...
- What was going on in September 2016?
    ...
    That year when I attended [Write the Docs in Prague](https://www.writethedocs.org/) I diligently wrote an article about the [each talk]({% link _posts/2016-09-20-wtd.html.md %}).  That caused a lot of extra posts.
...
- DevConf.cz
- [Diversity FAD]({% link _posts/2017-02-07-fedora-diversity-fad.md %})
- [FOSDEM]({% link _posts/2017-02-10-fedora-fosdem.html %})
- Council FAD
- [RH Summit]({% link _posts/2017-07-13-event-report-red-hat-summit.md %})
- [Community Leadership Summit]({% link _posts/2017-07-13-event-report-community-leadership-summit.md %})
- [GrimoireCon]({% link _posts/2017-07-13-event-report-grimoirecon.md %})
- [OSCON]({% link _posts/2017-07-13-event-report-oscon.md %})
- [OSCAL]({% link _posts/2017-07-14-event-report-oscal.md %})
- [Open Source Summit Japan]({% link _posts/2017-07-14-event-report-japan.md %})
- [Education Day, Red Hat China]({% link _posts/2017-07-13-event-report-china.md %})
- [LinuxCon China]({% link _posts/2017-07-13-event-report-china.md %})
- [LATAM Organizational FAD]({% link _posts/2017-07-18-event-report-latam-org-fad.md %})
- Flock
...
In the context of my public work in Fedora, I set a goal of writing a quarterly summary of what is going on for the FCAIC role in Fedora Magazine.  I wrote the first one in [October 2016]({% link _posts/2016-10-20-FCAIC-in-the-house.md %}) when I started the job.  I followed up successfully in [January 2017]({% link _posts/2017-01-26-FCAIC-in-the-house-2.html %}) and [April 2017]({% link _posts/2017-04-27-FCAIC-in-the-house-3.html %}).  The followup in July 2017 never happened.  I am not sure this is a huge loss.  Now that I am doing weekly reports (with some caveats) this may be more of a repeat than new information.

## Other Writing

I wrote [two]({% link _posts/2017-04-12-fedora-opensource.com-contributors.html %}) [posts]({% link _posts/2017-04-18-fedora-opensource.com-community.html %}) as part of an [opensource.com](https://opensource.com/) blogging challenge.  It was fun to do and made me think, but it was also a lot of work.  I encourage everyone to consider participating in one of these.  I strongly encourage you to start small, as in "do only every other week" not "every week" in order to rack up some success.  It is hard, but sharing your knowledge and organizing your thoughts on a topic are well worth the effort.

I also wrote five other pieces.  They included a bad cover/rewrite of a song about [packaging a piece of software]({% link _posts/2017-03-07-packaged-dayjournal.md %}) and two other quasi-tech pieces about [ERP]({% link _posts/2017-04-20-fixing-ERP.md %}) and [password management]({% link _posts/2017-03-09-password-change-api.md %}).  They were personal motivated, such a piece I wrote a few days ago [about saving our history]({% link _posts/2017-12-26-family-history-saver.md %}) and deeply off-topic but important to me such as this piece about [international taxation]({% link _posts/2017-01-09-international-taxes.md %}).
...
[^0]: Writing counts no matter where it is or why it was done.  Therefore, for the purposes of my goal, a weekly status report is equivalent to a post on another site is equivalent to a trip report is equivalent to a random article about [fictional years]({% link _posts/2016-01-04-year-of-the.md %}).
