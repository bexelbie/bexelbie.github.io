...
This works for any git forge out there.  If you're using GitHub, and have installed their [https://cli.github.com/](CLI client), you can simply the commands above with:
